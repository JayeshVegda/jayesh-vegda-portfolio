...
export const Projects: ProjectInterface[] = [
  {
    ...
    shortDescription:
      "A customizable search engine that allows users to organize and manage their favorite search sites across different categories with a clean, modern interface.",
  ...
  },
  {
    ...
    shortDescription:
      "A powerful RESTful API service for accessing GeeksForGeeks user data including profiles, solved problems, contest history, and submission calendars.",
  ...
  },
  {
    ...
    category: ["Web Dev", "Full Stack", "UI/UX"],
    shortDescription:
      "An academic project based on an online food ordering system with dynamic menu browsing, cart management, and order processing.",
    ...
    pagesInfoArr: [
      {
        ...
        description:
          "Main interface with menu browsing and food item display",
        imgArr: [
          "/projects/apnafood/1.png",
          "/projects/apnafood/2.png",
        ],
      },
      {
        title: "Cart & Checkout",
        description:
          "Shopping cart management and order processing interface",
        imgArr: [
          "/projects/apnafood/3.png",
          "/projects/apnafood/4.png",
        ],
      },
      {
        title: "User Dashboard",
        description:
          "User account management and order tracking features",
        imgArr: [
          "/projects/apnafood/5.png",
          "/projects/apnafood/6.png",
        ],
      },
    ],
    descriptionDetails: {
      paragraphs: [
        "Apna Food is an academic project based on an online food ordering system that I created as a comprehensive full-stack application. The platform features dynamic menu browsing, allowing users to explore available food items with detailed descriptions and pricing.",
        "I implemented a complete cart management system where users can add, remove, and modify items before checkout. The order processing system handles order placement, confirmation, and tracking. I built the entire application using PHP for server-side logic, MySQL for database management, and HTML, CSS, and Bootstrap for the frontend.",
        "The application features a responsive user interface using Bootstrap, ensuring a seamless experience across desktop and mobile devices. I implemented secure user authentication and session management to protect user data and orders. The system includes user registration, login, and profile management functionality.",
        "This project demonstrates my foundational skills in web development, including database design, server-side programming, and frontend development. The application showcases practical implementation of e-commerce concepts in a food delivery context.",
      ],
      bullets: [
        "Built full-stack online food ordering system with PHP and MySQL",
        "Implemented dynamic menu browsing and cart management functionality",
        "Created responsive UI with Bootstrap for cross-device compatibility",
        "Developed secure user authentication and session management",
        "Designed database schema for users, orders, and menu items",
        "Implemented order processing and tracking system",
      ],
    },
  },
];
